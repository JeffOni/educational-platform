...
const embedUrl = computed(() => {
    ...
    // Para file o spaces, retornar la URL directa
    return url;
});
...
const toggleComplete = () => {
    ...
    router.post(
        route('student.lessons.toggle', props.lesson.id),
        {},
        {
            preserveScroll: true,
            onFinish: () => {
...
const goToLesson = (courseId: number, lessonId: number) => {
    router.visit(
        route('student.lessons.show', { course: courseId, lesson: lessonId }),
    );
};
...
const submitQuestion = () => {
    questionForm.post(
        route('student.lessons.questions.store', props.lesson.id),
        {
            preserveScroll: true,
            onSuccess: () => {
                questionForm.reset();
...
const downloadResource = (resourceId: number) => {
    window.location.href = route('student.resources.download', resourceId);
};
...
const submitAssignment = (assignmentId: number) => {
    ...
    form.post(route('student.assignments.submit', assignmentId), {
        preserveScroll: true,
        onSuccess: () => {
            // Mantener el contenido pero resetear el archivo
            form.file = null;
        },
    });
};
            ...
            <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <div class="space-y-6 lg:col-span-2">
                        ...
                        <div>
                            <div class="mb-4 flex items-start justify-between">
                                ...
                                <button
                                    ...
                                    :disabled="processing"
                                    class="flex items-center gap-2 rounded-lg px-6 py-3 font-semibold transition-all duration-200"
                                    :class="
                                        isCompleted
                        ...
                        >
                            ...
                            <button
                                v-if="nextLesson"
                                @click="
                                    goToLesson(course.id, nextLesson.lesson.id)
                                "
                            ...
                            <div v-show="showResources" class="space-y-3">
                                ...
                                >
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="rounded-lg bg-indigo-50 p-2"
                                        >
                                            <FileText
                        ...
                        <div class="mt-8 border-t pt-6">
                            ...
                            <div v-show="showQuestions" class="space-y-6">
                                ...
                                >
                                    No hay preguntas aún. ¡Sé el primero en
                                    preguntar!
                                </div>
                    ...
                    <div class="lg:col-span-1">
                        <div
                            class="sticky top-8 rounded-xl border bg-white shadow-sm"
                        >
                            <!-- Header -->
