...
import { BookOpen, CheckCircle2, Clock, Award, TrendingUp, Calendar } from 'lucide-vue-next';
                ...
                <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div v-if="enrolledCourses.length === 0" class="py-12 text-center">
                                    <BookOpen class="mx-auto h-16 w-16 text-gray-300" />
                                    <p class="mt-4 text-gray-600">
                                        Aún no estás inscrito en ningún curso
                                    </p>
                                    <Button class="mt-4" @click="router.visit('/')">
                                        Explorar Cursos
                                    </Button>
                                </div>
                                ...
                                <div v-else class="space-y-4">
                                    <div
                                        ...
                                        :key="course.id"
                                        class="flex gap-4 rounded-lg border p-4 transition-all hover:shadow-md cursor-pointer"
                                    ...
                                    >
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <Progress :model-value="course.progress" class="mt-2" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div v-if="pendingAssignments.length === 0" class="py-8 text-center">
                                    <CheckCircle2 class="mx-auto h-12 w-12 text-green-300" />
                                ...
                                <div v-else class="space-y-3">
                                    ...
                                    >
                                        <div class="mb-2 flex items-start justify-between">
                                            ...
                                            <Badge :class="getDueDateColor(assignment.due_date)" class="ml-2 shrink-0">
